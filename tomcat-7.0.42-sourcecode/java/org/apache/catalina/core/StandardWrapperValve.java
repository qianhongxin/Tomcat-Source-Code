...
final class StandardWrapperValve
     ...
     * 判断servlet 是否实现了 CometProcessor 接口，如果实现了
     * 则设置 request 的comet（Comet：基于 HTTP 长连接的“服务器推”技术） 属性为 true。
     * 获取 ApplicationFilterFactory 单例（注意：这个获取单例的代码是有线程安全问题的），调用该单例的 createFilterChain
     * 方法获取 ApplicationFilterChain 过滤器链实例。
